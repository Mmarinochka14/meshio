        ...
        {isLoading ? (
          ...
          <div className="cart-page__empty">
            ...
            <p className="cart-page__empty-text text-p2">
              Добавьте понравившиеся платные модели в корзину, чтобы вернуться к
              ним позже и перейти к покупке.
            </p>
            ...
            <aside className="cart-page__summary">
              <div className="cart-page__summary-card">
                ...
                <p className="cart-page__summary-note text-p3">
                  Оплата и расчёт комиссии платформы будут подключены следующим
                  этапом.
                </p>

                {!isBuyer ? (
                  <p className="cart-page__summary-note text-p3">
                    Для оформления заказа потребуется вход в аккаунт покупателя.
                  </p>
                ) : null}
              </div>
            </aside>
